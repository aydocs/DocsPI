    ...
    <div className={`fixed inset-0 z-[100] flex items-center justify-center p-6 ${theme === 'dark' ? 'bg-zinc-950' : 'bg-white'}`}>
      <div className="max-w-md w-full text-center space-y-8 animate-fade-up">
        <div className="flex justify-center">
          <div className="w-24 h-24 bg-blue-500 rounded-3xl flex items-center justify-center shadow-2xl shadow-blue-500/20">
        ...
        <div className="space-y-4">
          <button
            onClick={onFinish}
            className="w-full py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-2xl font-bold text-lg transition-all active:scale-[0.98] shadow-xl shadow-blue-600/20"
          >
            {t.welcomeNext}
          </button>
