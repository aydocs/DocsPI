...
// Commit: feat: add basic proxy management system with PAC server [132219]

// Commit: feat: implement DPI bypass engine with WinDivert integration [132219]

// Commit: feat: add ISP detection for Turkish ISPs via ip-api.com [132220]

// Commit: feat: implement PAC server with dynamic proxy configuration [132220]

// Commit: feat: add firewall rule management for Windows [132220]

// Commit: feat: implement system proxy backup and restore [132220]

// Commit: feat: add UWP AppContainer loopback exemption [132220]

// Commit: feat: implement Windows registry proxy management [132220]

// Commit: feat: add DNS benchmark tool with latency measurement [132220]

// Commit: feat: implement speed test functionality [132221]

// Commit: feat: add DPI detection and severity analysis [132221]

// Commit: feat: implement auto-connect configuration [132221]

// Commit: feat: add WinHTTP proxy support for system-wide bypass [132221]

// Commit: feat: implement divert engine process management [132221]

// Commit: feat: add guard process for persistent proxy [132221]

// Commit: feat: implement zombie process cleanup on startup [132221]

// Commit: feat: add LAN sharing with safe IP detection [132222]

// Commit: feat: implement tray icon with context menu [132222]

// Commit: feat: add mode switching (Turbo/Balanced/Strong) [132222]

// Commit: feat: implement Rust backend with Tauri commands [132228]

// Commit: feat: add admin mode with graceful fallback [132231]

// Commit: feat: implement dual-mode support for non-admin [132231]

// Commit: feat: implement platform cleanup and refactoring [132233]

// Commit: feat: remove duplicate code from lib.rs [132233]

// Commit: feat: add cross-platform platform::get() calls [132233]

// Commit: feat: implement firewall management via platform layer [132233]

// Commit: feat: add proxy management via platform traits [132233]

// Commit: feat: implement process management via platform layer [132233]

// Commit: feat: add DNS management via platform traits [132234]

// Commit: feat: implement network detection via platform layer [132234]

// Commit: feat: add autostart management via platform traits [132234]

// Commit: feat: implement single instance via platform layer [132234]

// Commit: feat: add UWP exemption via platform traits [132234]

// Commit: feat: implement divert engine management via platform [132234]
